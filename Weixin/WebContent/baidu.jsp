...
<script type="text/javascript">
	...
	map.addEventListener("click",function(e){
		...
		//alert("点击点坐标:" + e.point.lng + "," + e.point.lat);
	});
    
    function myFun(result){
        var cityName = result.name;
//      map.setCenter(cityName);
        //document.getElementById("p").innerHTML = "定位城市: "+cityName;
        $("#p").append(cityName + ",");
    ...
    myCity.get(myFun);
        ...
        geolocation.getCurrentPosition(function(r){
            if(this.getStatus() == BMAP_STATUS_SUCCESS){
                ...
                map.panTo(r.point);
                //document.getElementById("p2").innerHTML = "定位位置 经度: "+ (r.point.lng).toFixed(3)+" 纬度: "+ (r.point.lat).toFixed(3);    
...
<script id="demo">
    ...
    function addMarker(point, id, name, adress){  // 创建图标对象
        ...
        var myIcon = new BMap.Icon("image/jiayouzhan.png",new BMap.Size(30,30));
