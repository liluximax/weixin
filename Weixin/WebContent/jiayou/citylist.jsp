...
<style type="text/css">
        ...
        .nav-list li:nth-child(1), .nav-list li:nth-child(2), .nav-list li:nth-child(3), .nav-list li:nth-child(4), .nav-list li:nth-child(5), .nav-list li:nth-child(6) {
            height:65px;
        }
        ...
        .nav-list li:nth-child(1) .name {
            background-color:#41BCA4;
        }
        .nav-list li:nth-child(2) .name {
            background-color:#f7386d;
        }
        .nav-list li:nth-child(3) .name {
            background-color:#cbd6ae;
        }
        .nav-list li:nth-child(4) .name {
            background-color:#bbcdb3;
        }
        .nav-list li:nth-child(5) .name {
            background-color:#70ae95;
        }
        .nav-list li:nth-child(6) .name {
            background-color:#EB6C9F;
        }
        .nav-list li:nth-child(7) .name {
            background-color:#8dcd9b;
        }
        .nav-list li:nth-child(8) .name {
            background-color:#76c2e9;
        }
        .nav-list li:nth-child(9) .name {
            background-color:#2BE8B3;
        }
        .nav-list li:nth-child(10) .name {
            background-color:#fec43e;
        }
        .nav-list li:nth-child(11) .name {
            background-color:#fab6a0;
        }
        .nav-list li:nth-child(12) .name {
            background-color:#FAD2A0;
        }
...
<div >
    <div id="nav" >
    <span style="color: #0093D9;font-size: 18px;font-weight: bold;font-family: KaiTi_GB2312,KaiTi_GB2312; ">&nbsp;</span>
	<nav class="city">
			<ul class="nav-list">
<!--                 <li>
                    <div>
